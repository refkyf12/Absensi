        ...
        <div class="modal-content bg-gradient-danger">
          ...
          <div class="modal-footer">
            <form action="" method="post">
              ...
              {{ method_field('delete') }}
              <p>
              <button type="submit" class="btn btn-danger btn-flat btn-sm menu-sidebar">Hapus</button>
                <button type="button" class="btn btn-danger btn-flat btn-sm menu-sidebar" data-dismiss="modal">Close</button>
              </p>
            </form>
          </div>
